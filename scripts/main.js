...
map.on('click', function(e) {
  ...
  if (features.length) {
    ...
    popUp(clickedPoint);
    removeActive();
    var selectedFeature = clickedPoint.properties.name + '' + clickedPoint.properties.address,
      selectedFeatureIndex;
    var listings = document.getElementById('listings').childNodes;
    for (var i = 0; i < listings.length; i++)
      if (listings[i].textContent === selectedFeature)
        selectedFeatureIndex = i;
    var listing = document.getElementById('listing-' + selectedFeatureIndex);
    console.log(document.getElementById('listing-' + selectedFeatureIndex));
...
function buildLocationList(data) {
  //if (typeof active === 'undefined') active = active[0].textContent;
  for (i = 0; i < data.features.length; i++) {
    var currentFeature = data.features[i];
    var prop = currentFeature.properties;
    var activeFeature = prop.name + '' + prop.address;
    //console.log(active);
    ...
    //if(activeFeature === active) this.class.add('active');
...
function avg(arr) {
  var x = arr.map(function(v) {
      return v[0];
    })
    .reduce(function(a, b) {
      return a + b;
    });
  var y = arr.map(function(v) {
      return v[1];
    })
    .reduce(function(a, b) {
      return a + b;
...
function popUp(currentFeature) {
  ...
  var center = avg(currentFeature.geometry.coordinates[0]);
  popupString = '<img src=' + currentFeature.properties.img + '>' +
    '<h1 class="popup-title">' + currentFeature.properties.name + '</h1>' +
    '<h3 class="popup-desc"><i>' + currentFeature.properties.address + '</i></h3>' +
    '<ul class="popup-links"><li class="popup-link"><a href="https://www.google.com/maps/dir/Current+Location/' + center[1] + ',' + center[0] + '" target="_blank"><i class="material-icons">directions</i></a></li>'
  if (currentFeature.properties.website) popupString += '<li class="popup-link"><a href="' + currentFeature.properties.website + '" target="_blank"><i class="material-icons">link</i></a></li>'
  if (currentFeature.properties.menu) popupString += '<li class="popup-link"><a href="' + currentFeature.properties.menu + '" target="_blank"><i class="material-icons">restaurant_menu</i></a></li>'
  popupString += '</ul>'
